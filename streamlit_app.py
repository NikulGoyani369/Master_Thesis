...
description = """
<h3>Master Thesis Topic:- Collecting and analyse automatically generated feedback explanations</h3>
...
components.html(description, height=340, width=750, scrolling=True)
